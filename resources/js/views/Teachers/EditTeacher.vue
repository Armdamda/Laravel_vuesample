        ...
        <div class="-mx-3 flex flex-wrap">
            <div class="w-full px-3 sm:w-1/2">
                <div class="mb-4">
                    ...
                    <select v-model="teacher.subject" multiple class="border text-base font-medium border-gray-400 p-2 w-full text-gray-600  rounded-lg focus:outline-none  focus:border-gray-400">
            ...
            <div class="w-full px-3 sm:w-1/2">
                <div class="mb-4">
                    ...
                    <select v-model="teacher.gender" class="border border-gray-400 p-2 w-full text-gray-600  rounded-lg text-base font-medium focus:outline-none  focus:border-gray-400" required>
...
<script setup>
 import axios from 'axios';
  ...
  const getTeacher  = async (id) =>{
    ...
    teacher.name = res.data.data.name
    teacher.gender = res.data.data.gender
    teacher.subject =res.data.data?.subjects.map(item => item.id)
  }
  ...
  const updateTeacher = async()=>{
    error.value = ' '
    try {
        await axios.patch(`/api/teachers/${route.params.id}`,teacher)
