    ...
    <div class="bg-gray-50 px-12 py-2 rounded-md w-[70%] m-auto">
      ...
      <form>
          <div class="mb-4">
              ...
              <input type="text"  v-model="student.name" disabled class="border border-gray-400 p-2 w-full rounded-lg text-gray-600 focus:outline-none focus:border-gray-400" required>
          </div>    
