    ...
    <div class="bg-gray-50 px-12 py-2 rounded-md  m-auto w-[70%]">
        ...
        <form @submit.prevent="updateStudent">
            <div class="mb-4">
                ...
                <input type="text" v-model="student.name" placeholder="Username"
                    class="border text-base font-medium border-gray-400 p-2 w-full rounded-lg text-gray-600 focus:outline-none focus:border-gray-400"
                    required>
            </div>
...
const updateStudent = async () => {
    errors.value = ' '
    try {
        await axios.patch(`/api/students/${route.params.id}`, student)
